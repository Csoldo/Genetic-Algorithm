...
namespace genesis
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string fasz = "kitalalando string barmilyen hosszu lehet, de a fitness fuggvenyeket kell megirni hozza, es a mutatorokat, selectort, breederet, rendereret, es a godot, meg a simulatorokat, es a gene interface-t, es a gene implementaciokat";
